...
import static cn.znh.redstar.mbg.mapper.UmsAdminRoleRelationDynamicSqlSupport.*;
...
public interface UmsAdminRoleRelationMapper {
    ...
    int insertMultiple(MultiRowInsertStatementProvider<UmsAdminRoleRelation> multipleInsertStatement);
