...
import static cn.znh.redstar.mbg.mapper.OmsOrderReturnReasonDynamicSqlSupport.*;
...
public interface OmsOrderReturnReasonMapper {
    ...
    int insertMultiple(MultiRowInsertStatementProvider<OmsOrderReturnReason> multipleInsertStatement);
    ...
    default int insert(OmsOrderReturnReason record) {
        return MyBatis3Utils.insert(this::insert, record, omsOrderReturnReason, c ->
